...
from ..condominios.scripts import insertions as condominio_insertions
from ..dispositivos.scripts import insertions as dispositivo_insertions
...
def main():
    reload_db()
    user_insertions()
    condominio_insertions()
    dispositivo_insertions()
