function preparar_datos_singuardia_visita(datos){
    ...
    cargar_tabla_singuardia_visita(data)
}


function cargar_tabla_singuardia_visita(data){
    if ( $.fn.DataTable.isDataTable( '#data_singuardia_visita' ) ) {
        var table = $('#data_singuardia_visita').DataTable();
        table.destroy();
    }

    $('#data_singuardia_visita').DataTable({
        data:           data,
        deferRender:    true,
        scrollCollapse: true,
        scroller:       true,
        ...
        buttons: [
            {  extend : 'excelHtml5',
               ...
               title: 'Control y Registro Sin guardia Visita'  },
            {  extend : 'pdfHtml5',
