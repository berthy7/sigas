function preparar_datos_peatonal_residente(datos){
    ...
    cargar_tabla_peatonal_residente(data)
}


function cargar_tabla_peatonal_residente(data){
    if ( $.fn.DataTable.isDataTable( '#data_peatonal_residente' ) ) {
        var table = $('#data_peatonal_residente').DataTable();
        table.destroy();
    }

    $('#data_peatonal_residente').DataTable({
        data:           data,
        deferRender:    true,
        scrollCollapse: true,
        scroller:       true,
