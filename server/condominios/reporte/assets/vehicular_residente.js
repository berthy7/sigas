function preparar_datos_vehicular_residente(datos){
    ...
    cargar_tabla_vehicular_residente(data)
}


function cargar_tabla_vehicular_residente(data){
    if ( $.fn.DataTable.isDataTable( '#data_vehicular_residente' ) ) {
        var table = $('#data_vehicular_residente').DataTable();
        table.destroy();
    }

    $('#data_vehicular_residente').DataTable({
        data:           data,
        deferRender:    true,
        scrollCollapse: true,
        scroller:       true,
        ...
        buttons: [
            {  extend : 'excelHtml5',
               ...
               title: 'Control y Registro Vehicular Residente'  },
            {  extend : 'pdfHtml5',
