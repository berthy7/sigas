...
function eliminar(elemento){
    ...
    if (!b) {
        cb_title = "¿Deshabilitar  Modelo?"

    } else {
        cb_title = "¿Habilitar  Modelo?"
    }
    swal({
        title: cb_title,
        type: "warning",
